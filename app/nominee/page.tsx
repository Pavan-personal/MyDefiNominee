      ...
      {showCopied && (
        <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50">
          <div className={clsx("bg-black text-white px-6 py-3 rounded-lg shadow-lg flex items-center space-x-2 animate-bounce", isDarkMode ? "bg-white" : "bg-black")}>
            ...
            <span className={clsx("font-medium", isDarkMode ? "text-black" : "text-white")}>Address copied to clipboard!</span>
                ...
                <form onSubmit={(e) => { e.preventDefault(); createNomineeRequest.mutate(); }}>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative">
                      <input
                        type="text"
                        value={unlockDate ? new Date(unlockDate).toLocaleString('en-US', {
                          year: 'numeric',
                          month: 'short',
                          day: 'numeric',
                          hour: '2-digit',
                        ...
                        readOnly
                        className={clsx(
                          "w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent cursor-pointer",
                          isDarkMode 
                            ? "bg-gray-700 border-gray-600 text-white placeholder-gray-400" 
                            : "bg-white border-gray-300 text-black placeholder-gray-500"
                        )}
                        ...
                        onClick={() => {
                          ...
                          input.value = unlockDate || '';
                          input.className = 'absolute opacity-0 pointer-events-none';
                          document.body.appendChild(input);
                          input.click();
                          input.onchange = (e) => {
                            const target = e.target as HTMLInputElement;
                            if (target.value) {
                              setUnlockDate(target.value);
                            }
